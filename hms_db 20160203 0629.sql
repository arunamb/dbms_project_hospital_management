...
CREATE TABLE admitpatient_room (
  ...
  CONSTRAINT admitpatient_room_ibfk_1 FOREIGN KEY (PatientID)
    REFERENCES patientregistration(PatientID) ON DELETE cascade ON UPDATE cascade,
  CONSTRAINT admitpatient_room_ibfk_2 FOREIGN KEY (RoomNo)
    REFERENCES room(RoomNo) ON DELETE cascade ON UPDATE cascade,
...
CREATE TABLE admitpatient_ward (
  ...
  CONSTRAINT admitpatient_ward_ibfk_1 FOREIGN KEY (Wardname)
    REFERENCES ward(wardname) ON DELETE cascade ON UPDATE cascade,
...
CREATE TABLE users (
  ...
  CONSTRAINT users_ibfk_1 FOREIGN KEY (username)
    REFERENCES registration(username) ON DELETE cascade ON UPDATE cascade
)
ENGINE = INNODB
CHARACTER SET utf8
COLLATE utf8_general_ci;
...
CREATE TABLE dischargepatient_room (
  ...
  CONSTRAINT dischargepatient_room_ibfk_1 FOREIGN KEY (AdmitID)
    REFERENCES admitpatient_room(AdmitID) ON DELETE cascade ON UPDATE cascade
)
ENGINE = INNODB
AUTO_INCREMENT = 2
CHARACTER SET utf8
...
CREATE TABLE dischargepatient_ward (
  ...
  CONSTRAINT dischargepatient_ward_ibfk_1 FOREIGN KEY (AdmitID)
    REFERENCES admitpatient_ward(AdmitID) ON DELETE cascade ON UPDATE cascade
)
ENGINE = INNODB
AUTO_INCREMENT = 1
CHARACTER SET utf8
...
CREATE TABLE bill_room (
  ...
  CONSTRAINT bill_room_ibfk_1 FOREIGN KEY (DischargeID)
    REFERENCES dischargepatient_room(ID) ON DELETE cascade ON UPDATE cascade
)
ENGINE = INNODB
AUTO_INCREMENT = 2
CHARACTER SET utf8
...
CREATE TABLE bill_ward (
  ...
  CONSTRAINT bill_ward_ibfk_1 FOREIGN KEY (DischargeID)
    REFERENCES dischargepatient_ward(ID) ON DELETE cascade ON UPDATE cascade
)
ENGINE = INNODB
AUTO_INCREMENT = 1
CHARACTER SET utf8
...
('1', 'arunamb Sharma', 'CM Sharma', 'Indore', '9827858191', 'arunamb20505@gmail.com', 'MBBS', 'Heart', 'M', 'O+', '10/10/2014');
...
('admin', '12345', 'arunamb Sharma', '9827858191', 'arunamb20505@gmail.com');
